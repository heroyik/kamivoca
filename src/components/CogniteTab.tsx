...
export default function CogniteTab() {
  const { manualCogniteIds, removeManualCognite, clearAllManualCognites, globalDeletedWordKeys, stats, vocabEntries } = useGamification();

  const cogniteEntries = filterDeletedWords(vocabEntries as VocabEntry[], globalDeletedWordKeys)
